...
(function (global, factory) {
   ...
   * @return {Promise}
   */
  OAuth.prototype.exchangeForToken = function exchangeForToken(
    oauth,
    userData
  ) {
    if (oauth["denied"]) {
   ...
   */
  OAuth2.prototype.exchangeForToken = function exchangeForToken(
    oauth,
    userData
  ) {
    var this$1 = this;
   ...
   * @return {String}
   */
  OAuth2.prototype._stringifyRequestParams =
    function _stringifyRequestParams() {
      var this$1 = this;
